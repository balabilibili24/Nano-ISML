            ...
            for train_path in train_paths:
                for train_names in os.listdir(train_path):
                    if '.DS_Store' not in train_names:
                        self.imgs_red.append(train_path + '/' + train_names + '/' + 'Image {}_c1.png'.format(train_names))
                        self.imgs_green.append(train_path + '/' + train_names + '/' + 'Image {}_c2.png'.format(train_names))
...
if __name__ == '__main__':
    ...
    for ii, (data, img_path_red) in enumerate(train_dataloader):
        print(data.size())
        print(img_path_red)
