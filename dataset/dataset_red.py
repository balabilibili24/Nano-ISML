            ...
            for test_path in test_paths:
                for test_names in os.listdir(test_path):
                    if '.DS_Store' not in test_names:
                        self.imgs.append(test_path + '/' + test_names + '/' + 'Image {}.png'.format(test_names))
            ...
            for train_path in train_paths:
                for train_names in os.listdir(train_path):
                    if '.DS_Store' not in train_names:
                        self.imgs.append(train_path + '/' + train_names + '/' + 'Image {}.png'.format(train_names))
...
if __name__ == '__main__':
    ...
    test_data = dataset_red(train_data_root, train=True)
