...
from dataset.dataset_red import dataset_red
...
def train(**kwargs):
    ...
    # data
    train_data = dataset_red(opt.train_data_root, train=True)
    val_data = dataset_red(opt.train_data_root, val=True)
...
def test(**kwargs):
    ...
    # data
    test_data = dataset_red(opt.test_data_root, test=True)
